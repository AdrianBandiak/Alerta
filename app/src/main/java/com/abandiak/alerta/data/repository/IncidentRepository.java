...
public class IncidentRepository {
    ...
    public ListenerRegistration listenVisibleIncidentsForCurrentUser(
        ...
        if (uid == null) {
            ...
            inner[0] = listenWithAudTokens(buildTokens(null, null), type, regionBucket, region, listener);
            return proxy(inner);
        }
        ...
        db.collection("teams")
                ...
                .addOnSuccessListener(snap -> {
                    ...
                    Log.d("MAP_DEBUG", "User belongs to teams: " + teamIds);
                    List<String> tokens = buildTokens(uid, teamIds);
                    Log.d("MAP_DEBUG", "Final tokens used for listening: " + tokens);

                    inner[0] = listenWithAudTokens(tokens, type, regionBucket, region, listener);
                })
    ...
    private ListenerRegistration listenWithAudTokens(
        ...
        Log.d("MAP_DEBUG", "Listening with tokens: " + tokens + ", type=" + type);
